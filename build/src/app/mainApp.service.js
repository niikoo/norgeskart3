angular.module('mainApp').service('mainAppService', [
  ...
  function () {
    ...
    this.generateMapLinkServiceUrl = function (config) {
      ...
      return urlOpenWms + 'wms.topo2?service=' + service + '&request=' + request + '&CRS=' + crs + '&FORMAT=' + format + '&BGCOLOR=' + bgcolor + '&TRANSPARENT=' + transparent + '&LAYERS=' + layers + '&VERSION=' + version + '&WIDTH=' + width + '&HEIGHT=' + height + '&BBOX=' + bbox;
    };
