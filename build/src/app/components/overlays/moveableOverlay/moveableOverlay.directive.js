    ...
    return {
      ...
      link: function ($scope, element) {
        ...
        var getMouseEventX = function (event) {
          ...
          return angular.isNumber(event.clientX) ? event.clientX : event.touches[0].clientX;
        };
        ...
        var getMouseEventY = function (event) {
          ...
          return angular.isNumber(event.clientY) ? event.clientY : event.touches[0].clientY;
        };
      }
    };
  }
