    ...
    return {
      ...
      link: function (scope) {
        ...
        var _addSearchOptionToPanel = function (name, data) {
          switch (name) {
          case 'elevationPoint':
            scope.searchOptionsDict['ssrFakta'] = _constructSearchOption('ssrFakta', 'fa fa-flag', true, '"' + data.placename + '"', { url: mainAppService.generateFaktaarkUrl(data.stedsnummer) });
